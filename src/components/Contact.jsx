      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between">
          ...
          >
            ...
            <h2 className="text-3xl font-nunito font-bold mt-8">Contact Me</h2>
          ...
          >
            <h2 className="text-3xl font-nunito font-bold mb-8">Send me a Message or Email to collaborate</h2>
